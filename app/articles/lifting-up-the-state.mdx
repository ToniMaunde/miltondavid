...
In a common React.js Todo app, that allows you to add, edit and remove todos as well as sort, filter and display them as list or grid, the code would be similar to the one you can find in <ArticleLink text="this repository" href="https://github.com/ToniMaunde/lifiting-up-the-state" />. It uses useState() to manage the list of todos (add, delete, edit), and to set the filter for the list of todos.
